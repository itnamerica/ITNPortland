...
myApp.config(function($stateProvider, $urlRouterProvider, $locationProvider){
  ...
  var viewsPath = "views/";
  if (location.host === 'location:8080'){
    viewsPath = "app/views/";
  };
...
myApp.controller('MainController', ['$scope', '$transitions','$http', '$anchorScroll', '$location', '$stateParams', '$timeout', '$state', '$rootScope', '$window', function ($scope, $transitions, $http, $anchorScroll, $location, $stateParams, $timeout, $state, $rootScope, $window)  {
  ...
  $scope.submitForm = function(formType){
    ...
    $scope.loading = true;
    $http.post('/sendmail', {
      from: '"ITNPortland Web User" <donotreply@itnamerica.com>',
      to: 'itnamerica2018@gmail.com',
      subject: "ITNPortland Contact Form Submitted",
      text: $scope.formData,
  ...
  $scope.submitFormWithPDF = function(formType){
    ...
    if (formType === 'volunteer') {
        ...
        $scope.formSubject = 'ITNPortland - New volunteer application received';
        ...
        $scope.showPdf = true;
        $scope.formSubject = 'ITNPortland - New membership application received';
        $scope.generateMultiPagePDF();
